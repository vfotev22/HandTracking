...
public class Quest_to_firebase : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Create session title for this run
        ...
        FirebaseApp.CheckAndFixDependenciesAsync().ContinueWithOnMainThread(task =>
        {
            if (task.Result == DependencyStatus.Available)
            {
                ...
                app.Options.DatabaseUrl =
                    new Uri("https://YOUR_PROJECT_ID-default-rtdb.firebaseio.com/");
    ...
    void Update()
    {
        ...
        {
            // Save to local buffer for final JSON file
    ...
    void SendRealtime(Vector3 pos, Quaternion rot)
    {
        ...
        // Send under sessions/<sessionID>/<handName>/realtime
